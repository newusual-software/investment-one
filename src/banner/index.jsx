...
const HomeBanner = () => {
  ...
  return (
    <div
      className={`w-full relative overflow-hidden block z-10 before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-r before:from-[#272727] before:to-[#222] before:opacity-50 before:z-[-5] object-cover pl-14 h-[30rem] bg-cover bg-no-repeat bg-center bg-[url('${bannerData.image.cloudinaryUrl || "https://res.cloudinary.com/phantom1245/image/upload/v1708141308/investment-one/Frame_232_e2xwak.png"}')] flex flex-col justify-center`}
    >
